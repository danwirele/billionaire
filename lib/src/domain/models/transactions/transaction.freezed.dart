...
mixin _$TransactionModel {
 ...
 int get id; int get accountId; int get categoryId; String get amount; DateTime get transactionDate; DateTime get createdAt; DateTime get updatedAt; String? get comment;
...
@useResult
$Res call({
 int id, int accountId, int categoryId, String amount, DateTime transactionDate, DateTime createdAt, DateTime updatedAt, String? comment
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int accountId,  int categoryId,  String amount,  DateTime transactionDate,  DateTime createdAt,  DateTime updatedAt,  String? comment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransactionModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int accountId,  int categoryId,  String amount,  DateTime transactionDate,  DateTime createdAt,  DateTime updatedAt,  String? comment)  $default,) {final _that = this;
switch (_that) {
case _TransactionModel():
return $default(_that.id,_that.accountId,_that.categoryId,_that.amount,_that.transactionDate,_that.createdAt,_that.updatedAt,_that.comment);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int accountId,  int categoryId,  String amount,  DateTime transactionDate,  DateTime createdAt,  DateTime updatedAt,  String? comment)?  $default,) {final _that = this;
switch (_that) {
case _TransactionModel() when $default != null:
return $default(_that.id,_that.accountId,_that.categoryId,_that.amount,_that.transactionDate,_that.createdAt,_that.updatedAt,_that.comment);case _:
  return null;
